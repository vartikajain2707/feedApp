...
const initialPosts = [
  {
    ...
    content: 'Just had an amazing brainstorming session with the team. Excited about our new project!',
  ...
  },
  {
    ...
    content: 'Working on a new design system that will revolutionize our product experience. Stay tuned!',
...
const Feed = () => {
  ...
  const handleAddPost = (content: string) => {
    if (handleUnauthenticatedInteraction()) return
    ...
    const newPost: PostType = {
      ...
      author: {
        ...
        avatar: `https://i.pravatar.cc/150?u=${user?.id || 'anonymous'}`
      },
      content,
    ...
    <div className="min-h-screen bg-gray-100">
      <header className="bg-white shadow-sm">
        <div className="max-w-5xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-primary-600">Atlys</h1>
          <div>
            {isAuthenticated ? (
              <button 
              ...
              <a href={'/signup'} className="flex items-center">
                <button className="btn btn-secondary hover:bg-transparent bg-transparent">Login</button>
                <>
                  <svg className='cursor-pointer' width="20px" height="20px" viewBox="0 0 24 24" fill="none"
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        <PostEditor onSubmit={handleAddPost}
                    onInteraction={handleUnauthenticatedInteraction}
                    />
